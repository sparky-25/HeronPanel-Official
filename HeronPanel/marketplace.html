...
<html lang="en">
  <head>
    ...
    <title>HeronPanel Marketplace</title>
  ...
  <body data-page="marketplace">
    ...
    <video class="background-video" autoplay muted loop playsinline poster="assets/brand-logo.png">
    ...
    <main class="dashboard-shell marketplace-shell hidden" id="marketplaceShell">
      <header class="dashboard-topbar">
        <a class="brand" href="index.html">
          <img src="assets/brand-logo.png" alt="" class="brand-mark">
          <span><strong data-bind="panelName">HeronPanel</strong><small>Marketplace</small></span>
        </a>
        <div class="top-actions">
          ...
          <a class="ghost-button" href="index.html"><svg class="button-icon"><use href="#i-server"></use></svg>Dashboard</a>
          <button class="ghost-button" id="adminPanelBtn" type="button"><svg class="button-icon"><use href="#i-settings"></use></svg>Admin</button>
          <a class="primary-button" href="marketplace.html"><svg class="button-icon"><use href="#i-coin"></use></svg>Marketplace</a>
      ...
      <section class="dashboard-content marketplace-page-content" id="marketplaceContent"></section>
    </main>
